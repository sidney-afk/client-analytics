...
- [ ] Status/comment/due/assignee writes still require the authenticated gateway, a verified compatible role, active target, valid SyncView team authority, and fail-closed handling for missing/malformed authority.
