...
## 2026-09-09 — F27 Section 4 deploy, run `34398255854`: production-write 69 → 70

Dispatched from `483ac0841c526c5c7eba88b314a84eb44e4df89b` (PR #1371).
...
| `deliverable-write` | 35 | `78df060b7dd5b611e77b5427d7ab9a6cab1d0a18664f2e15562e098880074575` | verify_jwt=false |
| `linear-outbound` | 47 | `1489a4c276ca343554df2f4840c4f4b8ac77c33914098ee59a5d8b5cdec6ce39` | verify_jwt=false |
| `production-write` | 69 → **70** | `fc721251eeb6bd5c5f75456657ee51e105e452e6234a4121e61b93dd1b59de90` | verify_jwt=false |

```json
{
  "schema": "syncview_f27_section4_deployed_versions_v1",
  "deploy_commit": "483ac0841c526c5c7eba88b314a84eb44e4df89b",
  "github_run_id": "34398255854",
  "functions": [
    { "slug": "batch-write", "active_version": "35",
      ...
      "provider_bundle_sha256": "ccc36ce94f39efbb8db84a554eeaef6b5ce013547be5d2349ee8adbdddc2fda5",
      "verify_jwt": false },
    { "slug": "deliverable-write", "active_version": "35",
      "source_closure_sha256": "78df060b7dd5b611e77b5427d7ab9a6cab1d0a18664f2e15562e098880074575",
      "entrypoint_sha256": "74da8449a9f753a09cdf00326449df31664d18449c866b81923725aa6bad1e68",
      "provider_bundle_sha256": "3868706acd8e86632c960a6d08cc8ed94e3e8787237a530b135c6e5a05a1f3dd",
      "verify_jwt": false },
    { "slug": "linear-outbound", "active_version": "47",
      "source_closure_sha256": "1489a4c276ca343554df2f4840c4f4b8ac77c33914098ee59a5d8b5cdec6ce39",
      "entrypoint_sha256": "606628504ec4614a22e9d16c7671dc5d9ef73bfc57b69ecaa08065a5d14f3684",
      "provider_bundle_sha256": "b72429af7131bc954c8140f8f15c0c437c1fa4568f300bb3134a4f2752f8d626",
      "verify_jwt": false },
    { "slug": "production-write", "active_version": "70",
      "source_closure_sha256": "fc721251eeb6bd5c5f75456657ee51e105e452e6234a4121e61b93dd1b59de90",
      "entrypoint_sha256": "7a3136a65709c21c4b07d9b18873f8eb6732766fdd9b5c5c0677a4f69f849de5",
      "provider_bundle_sha256": "862d29e311ded98f3aa3665c61bb702032c94eb5565ba0b7e2f445d673d9a7fa",
      "verify_jwt": false }
  ]
}
```

Rollback bundle `c4485c7f21bbf232ccb232501edb4e557144a52deb19c37df189c9108e5281c2`,
`sealed_bundle_byte_length` = `560101`, sealing `production-write` v69 /
`ccbdd136f4…`.

**What changed.** `clientOperationAllowed` admits a client status write that is
a no-op (the row already holds the value asked for), which was previously
refused `403 operation_forbidden` and shown to the client as an accusation that
her account was not permitted to make the change (OPEN_REPAIRS 186). The status
handler additionally suppresses the overdue due-date bump for a client no-op, so
the newly admitted retry cannot move a due date through a side effect the client
is refused at the operation level. Only `policy.mjs` and `index.ts` moved; file
count 5, entrypoint unchanged.

**Note on what else this release carried.** The live set was still at v69, the
2026-09-07 pin, so this deploy also shipped the 2026-09-08 release (a Submit-tab
note and an AI thumbnail title are additive rather than mutually exclusive) which
had been merged but never deployed.
