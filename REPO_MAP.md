...
| `docs/audits/` | Dated audit evidence (2026-07-03 →). Historical record — do not edit old audits; add new dated files. `2026-07-19-boot-refresh-history-audit.md` is the immutable early-frame, refresh, and browser-history evidence behind F149–F162. Current conclusions belong in `docs/truth/`. |
