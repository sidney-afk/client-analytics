...
| F42 card-comment import | `scripts/f42-card-comment-import.js`, `docs/independence/F42_CARD_COMMENT_IMPORT_RUNBOOK.md`, `test/production-comment-slice.js` | Source-only two-surface Calendar+SXR planner with exact manifest/hash coverage, conflict classification, and no live connection or apply mode. |
