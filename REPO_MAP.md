...
| `docs/audits/` | Dated audit evidence (2026-07-03 →). Historical record — do not edit old audits; add new dated files. `2026-07-19-boot-refresh-history-audit.md` preserves the immutable early-frame/refresh/history evidence behind F149–F162 plus the separately labelled publication source-only read-truth recon behind F163–F169 and existing-owner expansions. Current conclusions belong in `docs/truth/`. |
