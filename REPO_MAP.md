...
| Reconcile crons | `scripts/linear-sync-reconcile.js`, `scripts/sample-linear-reconcile.js`, `scripts/linear-deliverables-reconcile.js`, `scripts/b1-linear-backfill.js`, `.github/workflows/f200-private-snapshot.yml`, `scripts/f200-attribution-live-snapshot.js` | Scheduled GitHub Actions plus a manually dispatched, aggregate-logging/private-artifact F200 read-only snapshot; `scripts/` also holds tested one-shot ops tools. |
