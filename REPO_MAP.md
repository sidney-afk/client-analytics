...
| `docs/audits/` | Dated audit evidence (2026-07-03 →). Historical record — do not edit old audits; append later handoffs. `2026-07-19-boot-refresh-history-audit.md` preserves the immutable early-frame/refresh/history evidence behind F149–F162, the separately labelled publication source-only read-truth recon behind F163–F169, remediation-phase controlled synthetic-browser Calendar evidence behind F170–F171, the source-only staff Analytics follow-up behind F172, and successive exact-head remediation-review evidence behind F173–F184. Its pre-split `c9a79ef` evidence remains historical. The later owner handoff parks F176/F179 containment intact in unmerged #908, non-blocking for #891 and out of scope for expansion here; current conclusions belong in `docs/truth/`. |
