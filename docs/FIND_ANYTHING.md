...
| How is the corrective F27 safety net installed or exactly rolled back? | `docs/ops/F27_INSTALL_RUNBOOK.md` — future owner-gated only; start from PR #901's no-install boundary |
