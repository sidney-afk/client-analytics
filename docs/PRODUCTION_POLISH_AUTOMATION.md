...
- interaction inventory across click, right-click, hover, selection, Escape, keyboard, filters, display options, display-driven project counts, filtered project-board copy, project-card context menu pickers, fake board-header/topbar action prevention, guarded read-only controls, and dead-button prevention;
