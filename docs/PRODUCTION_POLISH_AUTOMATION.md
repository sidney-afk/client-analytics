...
- interaction inventory across click, right-click, hover, selection, Escape, keyboard, filters, display options, display-driven project counts, filtered project-board copy, guarded read-only controls, and dead-button prevention;
