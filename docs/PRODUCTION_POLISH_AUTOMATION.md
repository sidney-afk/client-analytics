...
- interaction inventory across click, right-click, hover, selection, Escape, keyboard, filters, display options, display-driven project counts, filtered project-board copy, fake board-header action prevention, guarded read-only controls, and dead-button prevention;
