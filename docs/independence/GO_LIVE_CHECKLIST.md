...
|---|---|---|
| G1 Samples continuity and compatible recovery | [PR #1295](https://github.com/sidney-afk/client-analytics/pull/1295), `51fae03cda4335f883aaf854b11026251f1c8f4d`: six applicable hosted checks passed; two optional suites skipped. Integrated local browser checks cover eight draft groups, 13 forward/recovery/forward groups and 24 boot groups. | Refresh integration against current main and serving bytes; prove approved live client persistence and active W01/W02/W10. Its release packet preserves all G0/G1 gates. |
| G2/G3 accepted root-intake manifest | [PR #1293](https://github.com/sidney-afk/client-analytics/pull/1293), `5418ab5618595d9469f0527bd94623e9229a637e`: 41 actual-handler/SQL checks, three baseline controls and four hosted checks passed. | Additive schema and exact serving deployment are uninstalled. This records expected accepted work; it does not remove provider reads or materialize missing cards. A separate disabled native-epoch candidate is under review. Explicit VIDEO assignee selection still has a provider dependency under strict, missing or unreadable eligibility policy. |
...
| G4 dedicated component feedback | [PR #1297](https://github.com/sidney-afk/client-analytics/pull/1297), `5510ce03632d3a4d6953b6ecea79455b242bcd46`: seven applicable hosted checks passed, two optional checks skipped; 26 handler and 13 browser cases independently checked the corrected reader. | A broader local keyboard-guard snapshot failure is still being investigated and pixel proof remains incomplete. No merge or manual reader deployment is approved. This exact-mapped reader is not an import or a second discussion store. |
| W01/W02/W10 monitoring | Preserved [PR #1292](https://github.com/sidney-afk/client-analytics/pull/1292), `6383bd915bc0403d1b26140adda3cafe0d5f6749`, includes actual runner, observer, relay and safe transport diagnostics. The two approved primary failure/recovery DRILL DMs were independently read back on September 5. | Human acknowledgment, recurring scheduling and independent fallback remain unproved. Actual full viewer runs were held by blocked background transports. A separate positive Samples initial-read contract is being prepared; it cannot close approve/comment/tweak or full client-journey gates. |

Current remote main was captured as `34f6a888babe27acc4007a35ffcc87f8633484cc`; the preceding external `244de82a83a446d17b1a6b05e3b6c0828b631151` changed product HTML and `production-write`, and the final delta changed only `AGENTS.md`. The last coordinator live-browser receipt at 19:15:19 UTC used `a05e1126437bb8c36bd3f33e3701a58924a8627d`. It is historical evidence, not proof of the later deployment. Every integrated runtime and reviewed fix needs its own final review and applicable checks; green CI alone is not review.
...
| G1 | False-empty reproduced offline; fix not shipped | Frontend | Truthful failure, retained content, saving unchanged | Prior Pages only |
