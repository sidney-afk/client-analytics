...
**Decision A remains NOT READY.** The following are reviewed draft implementations and test evidence, not deployed behavior. This checkpoint extends the same G0–G10 sequence; it does not create another execution plan. The original September 4 snapshot, measurements and adjudication remain immutable historical evidence.

| Gate / deliverable | Exact checkpoint | What remains before release |
|---|---|---|
| G1 Samples continuity and compatible recovery | [PR #1295](https://github.com/sidney-afk/client-analytics/pull/1295), `e665ba77f95d832029c7b0c028c3011b249ea3a0`: reviewed integration of preserved `51fae03c` and captured main `5b9c0720`; six applicable hosted checks passed, two optional suites skipped. Eight owned-work groups, 13 forward/recovery/forward groups, 24 boot groups and 146 strict-monitor assertions passed. The independent Claude review reports all ten adversarial reader cases passing and closes its earlier reader findings. | One separate local integration against captured main `ab636613` is underway; its new tree and compatible recovery need fresh tests and review. Prove approved live client persistence and active W01/W02/W10. Static live HTML matched `5b9c0720` at 20:28:29 UTC; this is historical document evidence, not candidate deployment, share-link journeys or serving writers. |
| G2/G3 accepted root-intake manifest and staged native intake | [PR #1293](https://github.com/sidney-afk/client-analytics/pull/1293), `5418ab5618595d9469f0527bd94623e9229a637e`: 41 actual-handler/SQL checks, three baseline controls and four hosted checks passed. Stacked [PR #1302](https://github.com/sidney-afk/client-analytics/pull/1302), `8cb5cba91bc33fb17599b8f2a38625ae07f7743d`, adds disabled native epochs and provider-prerequisite bypass; 50 real handler/SQL native checks and all four hosted checks passed after independent review. | Uninstalled. Completion [PR #1308](https://github.com/sidney-afk/client-analytics/pull/1308) at `df3d0325cac89d3fa9a0fdcb004933025b25ad27` needs corrections for public diagnostic disclosure, late browser overwrites and deletion provenance. Assignment [PR #1309](https://github.com/sidney-afk/client-analytics/pull/1309) at `3c40c0aea84f709ac2cfaee8610f80a548b2d949` has two independently reproduced handler/SQL role-selection regressions plus catalog/provider-path scope gaps. Both require corrected heads and independent review; successful existing tests do not close those findings. |
| G3 recoverable action history | [PR #1299](https://github.com/sidney-afk/client-analytics/pull/1299), `85018bf83ab49527c79ca86d521c6a08a31e3277`: hosted 404 unit suites, 31 real journal checks and 14 backup/restore checks passed against the synthetic 21-table foundation. Independent Claude review `af929858628443cd6a44d85ad535d912dc26492a` reports ordinary journal capture intact but restores refused on a migration-built schema. | HOLD: correct the overly broad legacy guard and incomplete dependency corpus; preserve exact comment crosswalk/replay/intake receipts; provide an authenticated schema artifact and tested reconstruction recipe. Do not truncate unbacked dependent tables to make a drill pass. Failed-comment draft conservation, installed-schema verification, cloud delivery/restore, alarms and retention also remain required. The scheduled 14-table format is unchanged. |
...
| W01/W02/W10 monitoring | Preserved [PR #1292](https://github.com/sidney-afk/client-analytics/pull/1292), `6383bd915bc0403d1b26140adda3cafe0d5f6749`, includes actual runner, observer, relay and safe transport diagnostics. Separate initial-read [PR #1303](https://github.com/sidney-afk/client-analytics/pull/1303), `37b065b844725f89d8caed217bd369ec159cba77`, passed independent review and all four applicable hosted checks, including 108 initial-read assertions and 20 real-SDK scenarios. Two approved primary failure/recovery DRILL DMs were independently read back on September 5. | Human acknowledgment, recurring scheduling and independent fallback remain unproved. Actual full viewer runs were held by blocked background transports. Initial-read proof still needs an approved positive live canary and exact current page/SDK bindings; it cannot close approve/comment/tweak or full client-journey gates. |
...
All four Claude results have been received, and the owner confirmed forwarding both native correction prompts. Samples reader findings are closed at the reviewed heads; its new observer finding is independently reproduced defense in depth: a contradictory healthy receipt can pass the independent validator, although the shipped producer's containment latch prevents that combination. Local correction `92d261c45ab9bacef38829c0fc7c9597e344ca61` is independently reviewed, with 257 operations and 119 initial-read assertions rerun successfully. It adds manual crash-lock quarantine and per-binding directory instructions; it is unpushed, uninstalled and inactive, and does not establish a live scheduler incident or operational recovery. Published monitoring checkpoint counts above still belong to their original heads. The [history review](https://github.com/sidney-afk/client-analytics/blob/af929858628443cd6a44d85ad535d912dc26492a/docs/audits/2026-09-05-card-history-adversarial-review.md) supplies the restore/corpus blockers above. Its recommendation to discard unbacked dependent tables is rejected, and its claim that three proposed tables remove five foreign-key edges is not accepted: source inspection accounts for three. Independent migration-shaped reproduction and bounded correction are underway; no new successful restore is claimed.

Calendar recovery has an additional concrete boundary: the frozen comment-cell merge does not check the canonical comment's current version or lifecycle state. A native edit/delete/resolve after browser readback but before a missing-source copy can therefore make that copy stale; another read after writing is insufficient protection. The local frontend must retain visible unresolved text and hold that copy until an independently reviewed atomic source-repair contract exists. Exact already-persisted source can be reconciled without another write. This does not authorize changing or re-gating the frozen writers.
