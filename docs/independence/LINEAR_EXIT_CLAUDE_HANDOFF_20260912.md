...
> Follow-up review repairs are tracked in
> `../ops/LINEAR_EXIT_REVIEW_REPAIRS_20260913.md`. It records the new main-based
> preparation branch, refreshed exact-code switch/recovery proofs and current
> live-read gaps. The revisions and receipts below remain historical evidence;
> they are not a claim that the follow-up branch has already passed GitHub CI.
