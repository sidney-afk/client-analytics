...
4. **F55 authority vocabulary** — remove/migrate the backend `supabase` alias before any
   `prod_authority` change. (The F27 SQL applied today still normalizes it — the alias is live.)
