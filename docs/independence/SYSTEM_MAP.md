...
### 4.15b Clients (read-only, admin; new row 2026-09-25)
...
- **Writes.** None yet. Editing with an edit history (`source='syncview'`) is the plan's next step.
