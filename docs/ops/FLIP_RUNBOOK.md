...
> ready. Measured 2026-08-10: 142 of 328 active graphics sub-issues could not be proven natively —
> 133 with an erased label relation, 9 with no `deliverables` row at all. **F40 is now a data gate,
