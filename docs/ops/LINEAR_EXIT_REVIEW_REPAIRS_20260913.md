...
| Real pre-installation database backup shape | A dedicated native public-schema backup/restore path is being verified. Do not substitute the post-installation 94-table application codec for the current 67-table database. No live data has been exported. |
