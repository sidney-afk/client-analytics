...
## 157. [2026-09-05, DRAFT REPAIR — source and synthetic proof; release held] Samples could turn a failed or incomplete read into an empty board, and unfinished local work needed an owned recovery path
