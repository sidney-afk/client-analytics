...
## 154. [2026-09-05, EVIDENCE PACKAGE SHIPPED, no product change] Native intake without Linear: the three paths are provider-gated in front of every native write, and the only record of a card still owed is the browser that owed it
