...
4. [`tests/README.md`](tests/README.md) — runnable repository suites. Use `npm test` and
   ...
   a live backend. F105 repaired the post-#813 fixture/layout/read-audit epoch without weakening
   zero-mutation coverage; the exact candidate must still pass the complete aggregate before merge.
