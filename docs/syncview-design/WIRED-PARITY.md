...
17. Selected issue command menus visually take focus over the action bar. When the searchable `Actions` menu is open, the underlying selected-actions bar recedes instead of competing as a second active surface.
