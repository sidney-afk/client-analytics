...
| GitHub polish workflow and issue intake | `.github/workflows/production-polish-gate.yml`, `.github/ISSUE_TEMPLATE/production-polish.yml`, `.github/pull_request_template.md`, `AGENTS.md`, `.github/copilot-instructions.md` | ported | Production UI PRs that touch the relevant files run the polish gate in GitHub Actions; future rough owner feedback has an AI-ready issue template, PR checklist, and agent instructions. |
