...
function validatePacket(dir = packetDir) {
  ...
  if (!parentDetail || !parentDetail.evidence || parentDetail.evidence.hasScaffoldCopy || !/No activity yet|Activity|Comments|Feedback & tweaks/i.test(parentDetail.evidence.activityText || '')) {
  ...
  if (!subIssueDetail || !subIssueDetail.evidence || subIssueDetail.evidence.hasScaffoldCopy || !/No activity yet|Activity|Comments|Feedback & tweaks/i.test(subIssueDetail.evidence.activityText || '')) {
