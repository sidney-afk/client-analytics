...
>
> **Last refreshed: 2026-09-23** (Atlas run: client review save, staff card save/rename, client Samples half, Workload/Analytics open; see run history). Previous refresh 2026-07-20 (Workload release plus #889 client-only display/group-drag refresh:
...
- **Cleanup:** 0 probe samples open, 0 probe sub-issues open (6 canceled probe sub-issues remain as records). **Confirmed findings: none.**
