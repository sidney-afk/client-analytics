-- F202: allow guarded Production description intents in the existing B4 outbox.
--
...
-- parent, archive, restore, and labels, and adds only description. The
-- replacement is data-safe because it runs in one transaction, validates every
