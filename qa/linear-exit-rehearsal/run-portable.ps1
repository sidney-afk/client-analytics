...
try {
 ...
 if ($Lane -eq 'retirement-switch') { $entry=Join-Path $repoRoot 'test\linear-exit-retirement-switch-postgres.js' }
 if ($Lane -eq 'provider-comment-observation') { $entry=Join-Path $repoRoot 'test\linear-exit-provider-comment-observation.js' }
 if ($Lane -eq 'provider-terminal-history') { $entry=Join-Path $repoRoot 'test\linear-exit-provider-terminal-history.js' }
