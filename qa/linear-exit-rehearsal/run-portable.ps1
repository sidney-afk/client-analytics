...
$expectedMajor=if ($Lane -in @('f27','priority-observed-baseline','priority-application-recovery','sequence-consistency','sequence-application','credential-schema','credential-recovery') -or $RecoveryPostgres17) { '17' } else { '16' }
