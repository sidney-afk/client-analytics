...
function seed(id, nm) { up({ id, name: nm, order_index: 1, asset_url: 'https://frame.io/x/' + id, thumbnail_url: '', linear_issue_id: 'https://linear.app/syncsocial/issue/VID-' + id.slice(-4), video_deliverable_id: ('del_' + 'https://linear.app/syncsocial/issue/VID-' + id.slice(-4)).replace(/[^A-Za-z0-9_-]/g, '_'), video_status: 'Kasper Approval', graphic_status: 'Approved', status: 'Kasper Approval' }); }
