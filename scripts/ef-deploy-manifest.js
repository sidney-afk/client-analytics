...
const DELIBERATE_MANUAL = Object.freeze({
  ...
  'linear-outbound-evidence': 'Source-only read-only F98 credential observer; first deploy requires the exact reviewed release, `--no-verify-jwt`, and read-only Management API source/JWT fingerprint readback. It performs no flag, database, n8n, or Linear mutation.',
