'use strict';
// Read-only six-owner admission contract. No deployment or activation.
const fs=require('fs'),path=require('path'),crypto=require('crypto');
const ROOT=path.resolve(__dirname,'..');
const CONTRACT='docs/independence/LINEAR_EXIT_ADMISSION_SCHEMA_CONTRACT_20260912.json';
const CONTRACT_SHA='55e1a20a12cf357f29ef23768326c27efa09983d2292d50cebc99a0e0cbd74bc';
