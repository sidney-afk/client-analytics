...
const PIN='7411fe784373a84a9682ec84ed183ebc6571ff06e6776605b5291aadee36f8c6';
...
function generate({readFile=fs.readFileSync}={}){const pin=p=>({path:p,sha256:sha(readFile(path.join(ROOT,p)))});return {
 ...
 worker_sources:['compose','bundle','endpoint','postgres','transaction','worker','supervisor'].map(n=>pin('scripts/linear-exit-followup-'+n+'.mjs')),
