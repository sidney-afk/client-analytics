...
Scope remains bounded. This is not a full production schema installation, crash/restore rehearsal, or proof of intake/assignment/label business operations. Synthetic cards and external-service scaffolding remain inherited from the established F42 fixture. Workload, provisioning and notification checks cover the explicit cases above; media, reconciliation, full backup/recovery and hosted serving gates remain outside this lane. Retirement activation still refuses; the later admission concurrency case explicitly sets a future retired state inside the disposable fixture and is not evidence that activation works. Installation remains HOLD.
