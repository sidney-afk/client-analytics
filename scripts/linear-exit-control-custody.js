...
const complete=require('./linear-exit-control-companion');
...
const NAME='application-controls.bin';
...
function restore(o){const target=path.resolve(o.target),parent=fs.realpathSync(path.dirname(target));if(path.dirname(target)!==parent)throw Error('APPLICATION_CUSTODY_PARENT');
 ...
 return {control_application_validated:true,encrypted_custody_reopened:true,off_device_custody_proven:false,hosted_recovery_proven:false};
