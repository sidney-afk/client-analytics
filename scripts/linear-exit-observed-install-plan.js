...
function build(catalog,{contract}={}){
 ...
 const manifest=JSON.parse(fs.readFileSync(path.join(ROOT,'docs/independence/LINEAR_EXIT_INSTALL_SOURCE_INVENTORY_20260918_2.json')));inventory.verify(manifest);
