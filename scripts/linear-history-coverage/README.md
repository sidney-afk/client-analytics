...
For the authenticated backup adapter and current proof limits, see
[asset-reference coverage preparation](../../docs/independence/LINEAR_EXIT_ASSET_REFERENCE_COVERAGE_20260912.md).
