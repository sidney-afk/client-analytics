...
(async () => {
  ...
  writeSummary(`Applied **${ok}** corrections, ${fail} failed, and kept **${gated.length}** SyncView-authoritative differences detect-only; **${naParked.length}** N/A-parked pairs untouched. In sync: ${inSync}.`);
