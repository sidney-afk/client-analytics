...
const NATIVE_PROVISIONING_HISTORY_TABLES = Object.freeze([...NATIVE_CONTINUITY_HISTORY_TABLES,
  // Immutable service-only enrollment receipt. request_id is caller-owned text,
  // never an identity; clients already carries native_project_ids verbatim.
  { name: 'production_native_client_provisions', pk: 'request_id' },
  { name: 'syncview_retirement_admission', pk: 'singleton' },
  { name: 'production_native_identifier_mint', pk: 'team' },
  { name: 'production_native_identifier_grants', pk: 'identifier' },
  // Public URLs are recoverable ledger facts; Storage bucket state and bytes
