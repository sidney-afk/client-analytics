// Supabase Edge Function: calendar-reorder
//
// A2 port of the live calendar reorder writers. The browser routes here only
// when calendar_upsert_ef_clients contains the client; all other clients stay on
// n8n. This function updates order_index + updated_at for existing rows only.
//
// Required env:
//   SUPABASE_URL
