...
`generated deploy manifest is current and contains all 37 slugs including dormant write-diagnostics on the dispatch-only one-function lane (${(manifestCheck.stderr || '').trim()})`);
/*
