...
ok(manifestCheck.status === 0 && slugRows.length === 41
...
`generated deploy manifest is current and contains all 41 slugs including dormant write-diagnostics on the dispatch-only one-function lane (${(manifestCheck.stderr || '').trim()})`);
/*
