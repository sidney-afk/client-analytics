...
const suffix=` await require('./helpers/control-recovery-proof').run(cluster,{currentPublic:process.argv.includes('--current-public'),retirement:process.argv.includes('--retirement')});
