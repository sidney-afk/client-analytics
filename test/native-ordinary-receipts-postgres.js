...
async function main() {
  try {
    ...
    await require('./helpers/native-post-cutoff-assertions')({cluster,env,highWater,deliverableWrite,event,assertReceipt,ok,scalar,count,setCapability,rejection,json,psqlAsync});
