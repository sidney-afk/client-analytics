...
(async () => {
  ...
  ok(/const mutationHasMirror = !nativeAssignment && \(operation !== "comment" \|\| commentMirrorApplicable\)/.test(edge)
  ...
  'native assignments exclude mirrors while background drains preserve durable success responses');
