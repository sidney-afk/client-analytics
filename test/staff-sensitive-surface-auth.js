...
ok(pinnedLoop === 'notify production-write production-comments production-archive',
  'manual pinned deploy runs the notification sender before the write gateway and comment/archive readers');
